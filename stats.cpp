...
constexpr struct {
  ...
  uint32_t token;
    ...
    // Spell Names
    {"Identify", crc32c("Identify")},
    {"Create Food", crc32c("Create Food")},
    {"Force Sword", crc32c("Force Sword")},
    {"Heat Vision", crc32c("Heat Vision")},
    {"Dark Vision", crc32c("Dark Vision")},
    {"Recall", crc32c("Recall")},
    {"Teleport", crc32c("Teleport")},
    {"Resurrect", crc32c("Resurrect")},
    {"Remove Curse", crc32c("Remove Curse")},
    {"Cure Poison", crc32c("Cure Poison")},
    {"Sleep Other", crc32c("Sleep Other")},

    // Object Strings
    {"Light Source", crc32c("Light Source")},
    {"Hungry", crc32c("Hungry")},
    {"Thirsty", crc32c("Thirsty")},
    {"Magical Spell", crc32c("Magical Spell")},
    {"Temporary", crc32c("Temporary")},
};
...
static void init_defaults() {
  ...
  for (auto str : string_list) {
    auto cur = find_if(skill_names.begin(), skill_names.end(), [str](auto name) {
      return name.first == str.token;
    });
    if (cur == skill_names.end()) {
      skill_names.emplace_back(std::make_pair(str.token, str.name));
    }
  }
