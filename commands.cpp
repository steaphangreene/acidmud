...
int handle_command_wcreate(Object*, Mind*, const std::u8string_view, int, int);
...
constexpr Command static_comlist[COM_MAX] = {
    ...
    {COM_HELP,
     ...
     u8"Get help for a topic or command.",
     (REQ_ANY)},
    {COM_QUIT, u8"quit", u8"Quit the game.", u8"Quit the game.", (REQ_ANY)},

    {COM_NORTH, u8"north", u8"Travel north.", u8"Travel north.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_SOUTH, u8"south", u8"Travel south.", u8"Travel south.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_EAST, u8"east", u8"Travel east.", u8"Travel east.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_WEST, u8"west", u8"Travel west.", u8"Travel west.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_UP, u8"up", u8"Travel up.", u8"Travel up.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_DOWN, u8"down", u8"Travel down.", u8"Travel down.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    ...
    {COM_SLEEP, u8"sleep", u8"Go to sleep.", u8"Go to sleep.", (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_WAKE,
     u8"wake",
     u8"Wake up, or wake someone else up.",
     u8"Wake up, or wake someone else up.",
     (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_LIE, u8"lie", u8"Lie down.", u8"Lie down.", (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_REST, u8"rest", u8"Relax and rest.", u8"Relax and rest.", (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_SIT, u8"sit", u8"Sit down.", u8"Sit down.", (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_STAND, u8"stand", u8"Stand up.", u8"Stand up.", (REQ_CONSCIOUS | REQ_ACTION)},
    {COM_USE,
     u8"use",
    ...
    {COM_STOP,
     ...
     u8"Stop using a skill.",
     (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_CAST, u8"cast", u8"Cast a spell.", u8"Cast a spell.", (REQ_ALERT | REQ_UP | REQ_ACTION)},
    {COM_PRAY,
     u8"pray",
    ...
    {COM_CALL,
     ...
     u8"Shout something to all nearby.",
     (REQ_AWAKE | CMD_FLAVORTEXT)},
    {COM_SAY, u8"say", u8"Say something.", u8"Say something.", (REQ_AWAKE | CMD_FLAVORTEXT)},
    {COM_EMOTE,
     u8"emote",
...
static int handle_single_command(Object* body, std::u8string line, Mind* mind) {
  ...
  if (cnum == COM_USE) {
    ...
    if (skill == prhash(u8"Lumberjack")) {
      ...
      if (strcasestr8(body->Parent()->Noun().c_str(), u8"forest") &&
  ...
  if (cnum == COM_TELEPORT) {
    ...
    while (src) {
      ...
      comline += u8"\n";
      if (!strcasestr8(src->LongDescC(), comline.c_str())) {
        src = body->NextHasSkill(prhash(u8"Restricted Item"), src);
        continue;
      }
      break;
